...
\begin{align*}
I_{R_x} &= 4\frac{P_{R_x}}{\pi D_{R_x}^2}
\end{align*}

\section*{Gaussian Optics}
\begin{align*}
I(r) &= I_0 \left(\frac{\omega_0}{\omega}\right)^2 e^{-2\frac{r^2}{\omega^2}} \\
\\
2\omega &= \frac{\sqrt{2}\cdot \textrm{FWHM}}{\sqrt{\ln 2}} = 1.699\times \textrm{FWHM}
\\
\\
I(r) &= I_0 \cdot e^{-2r^2/\omega^2} \\
0.5 &= e^{-2r^2/\omega^2}
\end{align*}
...
\section{MTBF}
\begin{align*}
\lambda_\textrm{system} &= \sum \lambda_i \\
\textrm{MTBF}_\textrm{system} &= 1 / \lambda_\textrm{system}
\end{align*}
